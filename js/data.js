...
window.portfolioData = {
  ...
  projects: [
...

    {
      ...
      summary:
        "A 3D mobile racing game with dynamic controls, speed physics, collision detection, and a mobile-friendly interface.",

      highlights: [
        "Implemented vehicle movement and collision systems in C#.",
        "Designed mobile controls and gameplay UI.",
        "Optimised performance for Android devices."
      ],
